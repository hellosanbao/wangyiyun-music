    ...
    <div class="play-content">
        <div class="play-fixed flex-middle">
            ...
            <div class="ctrl flex-middle">
                ...
                <div class="center" @click="playMusic">
...
export default {
    name:'AudioPlay',
    computed:{
        ...mapState(['isPlay','songMsg','songList','curSongIndex'])
    },
    mounted(){
       if(this.isPlay){
    ...
    methods:{
        ...mapMutations(['changePlayeState', 'changeCurSongIndex','selectPlaySong']),
        //播放音乐
        playMusic(){
            this.changePlayeState(!this.isPlay)
        },
        changeCurSong(tip){
